...
class ThursdayIT extends StatefulWidget {
  static const String id = 'thursday_it';
  @override
  _ThursdayITState createState() => _ThursdayITState();
}

class _ThursdayITState extends State<ThursdayIT> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Thursday(IT)"),
        elevation: 0.0,
      ),
      body: ListView(
        ...
        children: <Widget>[
          ...
          InkWell(
            onTap: () async {
              if(await canLaunch("https://meet.google.com/mmg-nsta-juo?hs=122&authuser=0")) {
                await launch("https://meet.google.com/mmg-nsta-juo?hs=122&authuser=0");
              }
            },
            child: Container(
              height: 150,
