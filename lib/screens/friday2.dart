...
class Friday2 extends StatefulWidget {
  static const String id = 'friday2';
  @override
  _Friday2State createState() => _Friday2State();
}

class _Friday2State extends State<Friday2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Friday(CSE : 2C+2D)"),
        elevation: 0.0,
      ),
      body: ListView(
