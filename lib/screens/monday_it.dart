...
class MondayIT extends StatefulWidget {
  static const String id = 'monday_it';
  @override
  _MondayITState createState() => _MondayITState();
}

class _MondayITState extends State<MondayIT> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Monday(IT)"),
        elevation: 0.0,
      ),
      body: ListView(
